...
export const brand = {
  ...
  domain: "flood-solutions-inc.invalid",
  canonicalUrl: "https://flood-solutions-inc.invalid",
  phone: "(586) 580-0197",
  ...
  placeId: "",
  googleCid: "",
  imagesBase: "https://images.flood-solutions-inc.invalid",
  googleMapsApiKey: "",
  // Analytics — set post-scaffold (scripts/analytics_set.py / create_ga4.py); no-op if empty
  ga4MeasurementId: "",
  clarityProjectId: "",
  logoUrl: "https://images.flood-solutions-inc.invalid/brand/logo.png",
